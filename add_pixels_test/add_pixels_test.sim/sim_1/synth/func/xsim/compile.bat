...
REM
REM Generated by Vivado on Sat Apr 23 11:47:33 +0800 2022
...
echo "xvlog --incr --relax -prj add_pixel_tb_vlog.prj"
call xvlog  --incr --relax -prj add_pixel_tb_vlog.prj -log xvlog.log
