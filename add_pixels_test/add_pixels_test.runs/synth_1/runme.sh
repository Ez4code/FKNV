...
HD_PWD='F:/FKNV/add_pixels_test/add_pixels_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_pixel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_pixel.tcl
