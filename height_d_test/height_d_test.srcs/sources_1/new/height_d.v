...
module height_d(
    ...
    always@(posedge clk)begin
        case(bmp_height + 7'd76)
            10'b00_xxxx_xxxx    :   out_height <= (bmp_height << 2'b10);      //how many cylces need?
            10'b01_xxxx_xxxx    :   out_height <= (bmp_height << 2'b10) + 2'd1;
            10'b1x_xxxx_xxxx    :   out_height <= (bmp_height << 2'b10) + 2'd2;
