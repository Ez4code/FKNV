...
HD_PWD='F:/FKNV/height_ds_test/height_ds_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log height_d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source height_d.tcl
