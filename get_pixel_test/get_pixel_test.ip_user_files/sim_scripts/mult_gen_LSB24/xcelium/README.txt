...
#
# Generated by export_simulation on Mon Apr 25 20:00:11 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './mult_gen_LSB24.sh' script.

./mult_gen_LSB24.sh -reset_run
...
./mult_gen_LSB24.sh -noclean_files

For more information on the script, please type './mult_gen_LSB24.sh -help'.
