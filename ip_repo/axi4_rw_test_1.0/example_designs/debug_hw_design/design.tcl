...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins axi4_rw_test_0/M_AXI]
	connect_bd_net [get_bd_pins axi4_rw_test_0/m_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi4_rw_test_0/m_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi4_rw_test_0/m_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins axi4_rw_test_0/m_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins axi4_rw_test_0/m_axi_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]
	...
	set_property range 16K [get_bd_addr_segs {axi4_rw_test_0/M_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells axi4_rw_test_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:axi4_rw_test:1.0]]]]
