...
HD_PWD='F:/FKNV/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_pixel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_pixel.tcl -notrace
