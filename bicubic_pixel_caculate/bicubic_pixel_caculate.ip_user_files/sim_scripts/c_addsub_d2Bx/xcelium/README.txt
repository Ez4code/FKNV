...
#
# Generated by export_simulation on Thu Apr 21 08:23:01 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './c_addsub_d2Bx.sh' script.

./c_addsub_d2Bx.sh -reset_run
...
./c_addsub_d2Bx.sh -noclean_files

For more information on the script, please type './c_addsub_d2Bx.sh -help'.
