...
HD_PWD='F:/FKNV/bicubic_pixel_caculate/bicubic_pixel_caculate.runs/c_addsub_d2Bx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_d2Bx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_d2Bx.tcl
