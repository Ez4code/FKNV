...
HD_PWD='F:/FKNV/bicubic_pixel_caculate/bicubic_pixel_caculate.runs/mult_gen_LSB24_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_LSB24.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_LSB24.tcl
