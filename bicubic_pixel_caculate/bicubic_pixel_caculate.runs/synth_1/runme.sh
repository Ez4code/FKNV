...
HD_PWD='F:/FKNV/bicubic_pixel_caculate/bicubic_pixel_caculate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log get_pixel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source get_pixel.tcl
