...
HD_PWD='F:/FKNV/bicubic_pixel_caculate/bicubic_pixel_caculate.runs/mult_gen_singed_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_singed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_singed.tcl
