...
HD_PWD='F:/FKNV/bicubic_pixel_caculate/bicubic_pixel_caculate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log get_pixel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source get_pixel.tcl -notrace
