...
HD_PWD='F:/FKNV/SD2HDMI/SD2HDMI/SD2HDMI.runs/SD2HDMI_rgb2dvi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SD2HDMI_rgb2dvi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SD2HDMI_rgb2dvi_0_0.tcl
